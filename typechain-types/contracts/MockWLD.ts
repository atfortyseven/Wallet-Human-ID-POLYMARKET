...
export interface MockWLDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockWLD extends BaseContract {
  connect(runner?: ContractRunner | null): MockWLD;
  waitForDeployment(): Promise<this>;

  interface: MockWLDInterface;
